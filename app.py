...
# # Initialize resources in session state to avoid duplication
...
#         # Debugging: Display raw chat history
#         # st.sidebar.write("Raw Chat History:", chat_history)
